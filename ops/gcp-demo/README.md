...
repositorio, o `docker compose up` e o Caddy com TLS automatico e Basic Auth
temporario. Um `terraform apply` deixa a demo no ar.
...
remova o bloco `basic_auth` de `/etc/caddy/Caddyfile` (seguido de
